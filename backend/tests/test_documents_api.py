...
def test_parse_pdf_returns_200():
...
def test_parse_unsupported_extension_returns_415():
...
def test_parse_scanned_pdf_returns_422():
...
def test_parse_oversized_file_returns_413():
